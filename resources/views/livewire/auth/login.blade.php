...
<header class="section-header border-bottom fixed-top bg-black">	
	<section class="header-main ">
		<div class="container">
			<div class="row gy-3 align-items-center">
            @php($store_logo=\App\Model\BusinessSetting::where(['key'=>'logo'])->first()->value)
				<div class="col-4">
					<a href="" class="navbar-brand text-light fs-3 fw-bold text-uppercase">
						Lacrostini
...
<!-- ============== SECTION CONTENT  ============== -->
<section class="padding-y bg-black d-flex align-items-center" >
  	<div class="container" style="margin-block:70px;">

		<!-- ====== COMPONENT LOGIN  ====== -->
		<div class="card shadow mx-auto bg-dark-50 " style="max-width:400px; margin-top:42px;">
			<div class="card-body ">
			...
			@csrf
				...
				<div class="mb-3">
					...
					<input wire:model="email" class="form-control bg-dark-50" placeholder="Type email" type="text">
				</div> 
				
				<div class="mb-3">
					<label class="form-label">Password</label>
					<input wire:model="password" class="form-control bg-dark-50" placeholder="At least 6 characters." type="password">
				</div>  
