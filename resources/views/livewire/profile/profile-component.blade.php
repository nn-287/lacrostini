          ...
          <article class="card bg-dark-50">
            <div class="card-body ">
                  ...
                  <div class="col-lg-8">
                    <div class="row gx-3">
                      <div class="col-6 mb-3">
                        ...
                        <div>
                          <input class="form-control bg-dark-50 text-white-50 " type="text" placeholder="Type here" wire:model="f_name" value="{{$user->f_name}}" required>
                          @error('f_name')
                      ...
                      <div class="col-6  mb-3">
                        ...
                        <div>
                          <input class="form-control bg-dark-50 text-white-50" type="text" placeholder="Type here" wire:model="l_name" required>
                          @error('l_name')
                          <span role="alert" style="color:red; font-size:smaller; font-style:italic">{{$message}}</span>
                          @enderror
                        </div>
                      ...
                      <div class="col-lg-6 col-md-6 mb-3">
                        ...
                        <div>
                          <input class="form-control bg-dark-50 text-white-50" type="email" placeholder="example@mail.com" wire:model="email" required>
                          @error('email')
                          <span role="alert" style="color:red; font-size:smaller; font-style:italic">{{$message}}</span>
                          @enderror
                        </div>
                      ...
                      <div class="col-lg-6 col-md-6 mb-3">
                        ...
                        <div>
                          <input class="form-control bg-dark-50 text-white-50" type="tel" placeholder="+1234567890" wire:model="phone" required>
                          @error('phone')
                          <span role="alert" style="color:red; font-size:smaller; font-style:italic">{{$message}}</span>
                          @enderror
                        </div>
                      ...
                      <div class="col-lg-12  mb-3">
                        ...
                        <div>
                          <input class="form-control bg-dark-50 text-white-50" type="text" placeholder="Type here" wire:model="address" required>
                          @error('address')
                          <span role="alert" style="color:red; font-size:smaller; font-style:italic">{{$message}}</span>
                          @enderror
                        </div>
              ...
              <div class="row" style="max-width:920px">
                <div class="col-md">
                  <article class="box mb-3 bg-dark-50">
                    <a class="btn float-end btn-light btn-sm" href="{{route('profile.change-password')}}">Change</a>
                    <p class="title mb-0">Password</p>
                    <small class="text-white-50 d-block" style="width:70%">You can reset or change your password by clicking here</small>
                  </article>
                </div> <!-- col.// -->
                <div class="col-md">
                  <article class="box mb-3 bg-dark-50">
                    ...
                    <small class="text-white-50 d-block" style="width:70%">Once you delete your account, there is no going back.</small>
                  </article>
                </div> <!-- col.// -->
              </div> <!-- row.// -->
