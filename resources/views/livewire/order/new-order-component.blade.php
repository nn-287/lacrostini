...
<section  class="padding-y bg-light bg-black">
...
<div class="row">
	...
	<main class="col-lg-9 mt-2 mt-lg-0">
		...
		<article class="card mb-3 bg-dark-50">
			<div class="card-body bg-dark-50">
				...
				<div class="row">
					<div class="col-md-4">
						<p class="mb-0 text-white fw-bold">Contact</p>
						<p class="m-0"> 
						{{$client_address->contact_person_name}}<br>  Phone: {{$user->phone}} <br> Email: {{$user->email}} </p>
					</div> <!-- col.// -->
					<div class="col-md-4 border-start">
						<p class="mb-0 text-white fw-bold">Shipping address</p>
						<p class="m-0">  
							{{$client_address->address}}  </p>
					</div> <!-- col.// -->
					<div class="col-md-4 border-start">
						<p class="mb-0 text-white fw-bold">Payment</p>
						<p class="m-0">
							<span class="text-info"> {{$order->payment_method}}   </span> <br> 
