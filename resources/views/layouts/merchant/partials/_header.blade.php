    ...
    <header id="header"
        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('merchant.dashboard')}}" aria-label="">
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img"
                                         onerror="this.src='{{asset('public/assets/admin/img/160x160/img1.jpg')}}'"
                                         src="{{asset('storage/app/public/admin')}}/{{auth('merchant')->user()->image}}"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5">{{auth('merchant')->user()->f_name}}</span>
                                            <span class="card-text">{{auth('merchant')->user()->email}}</span>
                                        </div>
                                    </div>
                                </div>
