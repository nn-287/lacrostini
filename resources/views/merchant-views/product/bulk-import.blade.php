...
@section('content')
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('merchant.dashboard')}}">{{trans('messages.dashboard')}}</a>
                </li>
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{route('merchant.product.list')}}">{{trans('messages.product')}}</a>
                </li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <form class="product-form" action="{{route('merchant.product.bulk-import')}}" method="POST"
