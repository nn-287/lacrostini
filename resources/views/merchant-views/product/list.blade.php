                    ...
                    <div class="card-header">
                        <div class="row" style="width: 100%">
                            ...
                            <div class="col-4 mb-3 mb-lg-0">
                                <a href="{{route('merchant.product.add-new')}}" class="btn btn-primary pull-right btn-block"><i
                                        class="tio-add-circle"></i> Add new Product</a><!--FLAGGGGGGGG-->
                            </div>
                        </div>
                    </div>
                    <!-- End Header -->
                                    ...
                                    <td>
                                        <span class="d-block font-size-sm text-body">
                                             ...
                                             display: -webkit-box;
                                               ...
                                               href="{{route('merchant.product.view',[$product['id']])}}">
                                               {{$product['name']}}
                                             </a>
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        @if($product['status']==1)
                                            <div style="padding: 10px;border: 1px solid;cursor: pointer"
                                                 onclick="location.href='{{route('merchant.product.status',[$product['id'],0])}}'">
                                                <span class="legend-indicator bg-success"></span>Active
                                            </div>
                                        @else
                                            <div style="padding: 10px;border: 1px solid;cursor: pointer"
                                                 onclick="location.href='{{route('merchant.product.status',[$product['id'],1])}}'">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="{{route('merchant.product.edit',[$product['id']])}}">Edit</a>
