...
<div class="content container-fluid">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('merchant.product.store-attribute')}}" method="post" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
        <form action="{{route('merchant.product.update-attributes-images',[$product['id']])}}" method="post" enctype="multipart/form-data">
            @csrf
