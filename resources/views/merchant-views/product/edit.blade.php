        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <form action="javascript:" method="post" id="product_form"
                    ...
                    @csrf
                    <input type="hidden" name="merchant_id" value="{{ Auth::guard('merchant')->id() }}"><!--FLAGGGG!!-->
                    ...
                    <div class="row" style="border: 1px solid #80808045; border-radius: 10px;padding-top: 10px;margin: 1px">
                        ...
                        <div class="col-md-12 mt-2 mb-2">
                            <div class="customer_choice_options" id="customer_choice_options">
                                @include('merchant-views.product.partials._choices',['choice_no'=>json_decode($product['attributes']),'choice_options'=>json_decode($product['choice_options'],true)])
                            </div>
                        </div>
                        <div class="col-md-12 mt-2 mb-2">
                            <div class="variant_combination" id="variant_combination">
                                @include('merchant-views.product.partials._edit-combinations',['combinations'=>json_decode($product['variations'],true)])
                            </div>
                        </div>
                    </div>
...
@push('script_2')
    ...
    <script>
        ...
        function combination_update() {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('merchant.product.variant-combination')}}',
    ...
    <script>
        $('#product_form').on('submit', function () {
            ...
            $.post({
                url: '{{route('merchant.product.update',[$product['id']])}}',//FLAGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG
                data: $('#product_form').serialize(),
                data: formData,
                cache: false,
                contentType: false,
