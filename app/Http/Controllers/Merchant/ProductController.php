...
class ProductController extends Controller
{
    ...
    public function variant_combination(Request $request)
    {
        ...
        return response()->json([
            'view' => view('merchant-views.product.partials._variant-combinations', compact('combinations', 'price', 'product_name'))->render(),
        ]);
    }
    ...
    public function index()
    {
        ...
        return view('merchant-views.product.index', compact('categories'));
    }
   ...
   public function list(Request $request)
    {
      ...
      if(count($product_ids) > 0){
        ...
        return view('merchant-views.product.list', compact('products', 'search'));
    }
    ...
    public function search(Request $request){
        ...
        return response()->json([
            'view'=>view('merchant-views.product.partials._table',compact('products'))->render()
        ]);
    }
    ...
    public function view($id)
    {
        ...
        return view('merchant-views.product.view', compact('product','reviews'));
    }
    ...
    //    $p->tax = $request->tax_type == 'amount' ? $request->tax : $request->tax;
      //  $p->tax_type = $request->tax_type;
        ...
        $p->merchant_id = Auth::id();//Set authenticated merchant ID
        // dd($p);
    ...
    public function edit($id)
    {
        ...
        $product->merchant_id = Auth::id();//Not necessary but might be

        return view('merchant-views.product.edit', compact('product', 'product_category', 'categories', 'sub_categories',  'cate_se', 'sub_cate_se',));
    }
    ...
    public function update(Request $request, $id)
    {
     ...
     //   $collection = collect(['region' => $request->price, 'price' => 'Desk']);
        ...
        $p->merchant_id = Auth::guard('merchant')->id(); // Authenticated merchant ID
        $p->save();
    ...
    {   
        ...
        return view('merchant-views.product.attributes-images', compact('product', 'variations', 'attributes'));
    }
    ...
    public function update_attributes_images(Request $request, $id)
    {
       ...
       $arr = []; 
        ...
        $product->merchant_id = Auth::id(); // Authenticated merchant ID
        $product->save();
        return redirect('merchant/product/edit/'.$id);
    ...
    public function store_attribute(Request $request)
    {
        ...
        $product->merchant_id = Auth::guard('merchant')->id();//Auth merchant ID 
        // $product->merchant_id =  auth('merchant')->id();
    ...
    {
        return view('merchant-views.product.bulk-import');
    }
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        foreach ($collections as $collection) {
             ...
             // merchant ID of each imported product
                $collection['merchant_id'] = Auth::id();
    ...
    public function addProductQaList(Request $request){
        return view('merchant-views.product.product-qa.create');
    }

   public function hairRoutine(Request $request){
   return view('merchant-views.product.product-qa.hairRoutine');
   }
   ...
   public function branches_info($id)
   {
       ...
       if($branch_ids !=null || $branch_ids != []){
           return view('merchant-views.product.branches-info.edit', compact('branch_ids', 'id', 'product'));
       }
       else 
       {
   ...
   public function save_info(Request $request)
    {
        ...
        foreach ($branch_ids as $branch_id) {
         ...
         // Set the merchant ID before saving the product
